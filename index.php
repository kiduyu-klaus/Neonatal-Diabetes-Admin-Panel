...
<body class="hold-transition lockscreen">
	...
	<div class="lockscreen-wrapper">
			...
			<form action="" method="post" class="lockscreen-credentials">
				<div class="input-group">
					...
					<div class="input-group-append">
						<button type="submit" name="login" class="btn"><i class="fas fa-arrow-right text-muted"></i></button>
					</div>
				</div>
			</form>
		...
		<div class="lockscreen-footer text-center">
			Copyright &copy; 2020 <b><a href="http://the-bookhub.co.ke" class="text-black">Sitemap</a></b><br>
			All rights reserved
		</div>
	</div>
	<!-- /.center -->
